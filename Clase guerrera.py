class Guerra():
 ...
 self.__terricolasNave = Nave(Guerreros.TERRICOLA, "Millenium
...
self.__terricolasNave.isWarriorAlive(warrior)):
...
self.__marcianosNave.isWarriorAlive(warrior)):
 ...
 raise Exception
Algoritmos y Estructuras de Datos Página 33 de 43
 def are_members_in_both_crews(self):
 if( (self.__terricolasNave.membersAlive()) > 0 and
